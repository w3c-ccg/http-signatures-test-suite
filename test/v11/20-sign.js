...
describe.skip('Sign should', function() {
  ...
  it.skip('MUST be able to discover metadata about the key from the `keyId`', async function() {
    /**
    ...
    */
    let error = null;
    try {
      await util.generate('nokeymetadata-request.httpMessage', generatorOptions);
    } catch(e) {
      error = e;
    }
